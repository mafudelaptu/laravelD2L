guard :concat, :type => "css", :files => %w[findMatch\queueStats main], :input_dir => "public/css", :output => "public/css/styles.min"

guard :concat, :type => "js", :files => %w[firebase main], :input_dir => "public/js", :output => "public/js/scripts.min"

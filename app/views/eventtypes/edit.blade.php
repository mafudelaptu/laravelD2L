...
<h1>Edit Eventtype</h1>
{{ Form::model($eventtype, array('method' => 'PATCH', 'route' => array('eventtypes.update', $eventtype->id))) }}
	<ul>
        <li>
		...
		<li>
			...
			{{ link_to_route('eventtypes.show', 'Cancel', $eventtype->id, array('class' => 'btn')) }}
		</li>
	</ul>
{{ Form::close() }}
